...
public record AutoRequestData(PackageOrder encodedRequest, PackageOrderCraftingContext encodedRequestContext,
	...
	public static final Codec<AutoRequestData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
		...
		PackageOrderCraftingContext.CODEC.fieldOf("encoded_request_context").forGetter(i -> i.encodedRequestContext),
	...
	public static final StreamCodec<RegistryFriendlyByteBuf, AutoRequestData> STREAM_CODEC = StreamCodec.composite(
		...
		PackageOrderCraftingContext.STREAM_CODEC, i -> i.encodedRequestContext,
	...
	public AutoRequestData() {
		this(PackageOrder.empty(), PackageOrderCraftingContext.empty(), "", BlockPos.ZERO, "null", false);
	}
